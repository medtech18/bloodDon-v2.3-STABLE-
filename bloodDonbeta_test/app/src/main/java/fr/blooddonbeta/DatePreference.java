...
public class DatePreference extends DialogPreference {
    ...
    public static int getYear(String dateval)
    {
        ...
        try {parsed = Integer.parseInt(pieces[2]);}catch (Exception e){e.printStackTrace();}
        return (parsed);
    }
    ...
    public static int getMonth(String dateval) {
        ...
        try {parsed = Integer.parseInt(pieces[1]);}catch (Exception e){e.printStackTrace();}
        return (parsed);
    ...
    public static int getDate(String dateval) {
        ...
        try {parsed = Integer.parseInt(pieces[0]);}catch (Exception e){e.printStackTrace();}
        return (parsed);
    }
